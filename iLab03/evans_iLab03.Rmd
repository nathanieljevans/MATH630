...
```{r}
upper_tcrit <- 0.025 # TWO TAIL; 0.05 / 2
test_stat<- mercury %>% 
...
pt(q=t, df=dof) # this ends up being supper high

```

#### Well this is clearly incorrect but I'm not sure how to think about this conceptually to remedy it. 
...
null_distn %>% 
  visualize(endpoints = t_test_CI, 
            direction = "between") # t_test_CI from above, it would be nice to plot the null distribution too
